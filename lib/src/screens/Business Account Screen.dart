...
class BusinessAccountScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        backTapButtonController.showAD(context, "/BusinessAccountScreen");
        return Future(() => false);
      },
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Business Account", style: GoogleFonts.lexend()),
        ),
        body: Stack(
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: HtmlWidget(
                      paySendAndReceiveController.BusinessAccData,
                      textStyle:
            ...
            payPalBannerController.BANNER("/BusinessAccountScreen")
          ],
        ),
      ),
    );
