...
import 'package:pay_pal_guide/src/utilities/PayPal%20Info%20Data.dart';
...
class PPInYourLanguageScreen extends StatelessWidget {
  const PPInYourLanguageScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        backTapButtonController.showAD(context, "/PPInYourLanguageScreen");
        return Future(() => false);
      },
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("PayPal Account With Card", style: GoogleFonts.lexend()),
        ),
        body: Stack(
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: HtmlWidget(
                      payPalInfoController.PPInYourLanguage,
            ...
            payPalBannerController.BANNER("/PPInYourLanguageScreen")
          ],
        ),
      ),
    );
