...
class PerSonalAccountScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        backTapButtonController.showAD(context, "/PerSonalAccountScreen");
        return Future(() => false);
      },
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Personal Account", style: GoogleFonts.lexend()),
        ),
        body: Stack(
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: HtmlWidget(
                      paySendAndReceiveController.PersonalAccData,
                      textStyle:
            ...
            payPalBannerController.BANNER("/PerSonalAccountScreen")
          ],
        ),
      ),
    );
