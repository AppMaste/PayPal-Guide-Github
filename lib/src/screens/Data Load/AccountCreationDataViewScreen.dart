...
class AccountCreationDataViewScreen extends StatefulWidget {
  ...
  @override
  _AccountCreationDataViewScreenState createState() =>
      _AccountCreationDataViewScreenState();
}

class _AccountCreationDataViewScreenState
    extends State<AccountCreationDataViewScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: GestureDetector(
          ...
          child: Image.asset(imageController.appBarLeftArrowImage, scale: 2.4),
        ),
      ...
      body: Stack(
        children: [
          ...
          payPalBannerController.BANNER("/AccountCreationDataViewScreen"),
        ],
      ),
    );
  }
