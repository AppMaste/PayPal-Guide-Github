...
class AccountWithCardScreen extends StatelessWidget {
  const AccountWithCardScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        backTapButtonController.showAD(context, "/AccountWithCardScreen");
        return Future(() => false);
      },
      child: Scaffold(
        ...
        body: Stack(
          children: [
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: HtmlWidget(
                      payPalInfoController.AccountWithCardData,
                      textStyle:
            ...
            payPalBannerController.BANNER("/AccountWithCardScreen")
          ],
        ),
      ),
    );
