...
class ReceiveScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        backTapButtonController.showAD(context, "/ReceiveScreen");
        return Future(() => false);
      },
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Receive Money", style: GoogleFonts.lexend()),
        ),
        body: Stack(
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: HtmlWidget(
                      paySendAndReceiveController.ReceiveData,
                      textStyle:
            ...
            payPalBannerController.BANNER("/ReceiveScreen")
          ],
        ),
      ),
    );
